...
8. When viewing your book online, open the reused page. At the top, you should see an **attribution box**. This confirms the external content is working correctly and shows where it was sourced from. 

```{figure} ..\figures\external_page_attribution.png
:name: external_page_attribution
:width: 100%
:alt: Attribution box shown at the top of an external page

Attribution box that appears at the top of an external page.
```
