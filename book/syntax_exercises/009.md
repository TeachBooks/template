...
3. If we want to refer to a section within the same file, we can use local refencing by directly inputting the name of the required section. The code below gives: [Jump to the next section](#referencing-an-equation)
